...
async function getInitialData() {
    try {
        const [
            ...
            supabaseAdmin.from("products").select("id,name,name_uz,name_ru,price,old_price,image,images,image_metadata,sales,rating,review_count,stock,stock_details,category_id,brand_id,video_url,model,color_name,group_id,is_original,article,created_at").eq("is_deleted", false).gt("stock", 0).order("created_at", { ascending: false }).limit(20),
