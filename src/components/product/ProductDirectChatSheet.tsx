...
export const ProductDirectChatSheet = ({
    ...
    const handleTouchEnd = () => {
        ...
        // Dismiss if dragged down > 110px OR velocity > 0.55 px/ms
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex flex-col justify-end pointer-events-auto" onClick={handleCloseWithAnimation}>
            {/* Backdrop */}
            <div
            ...
            >
                ...
                {/* Header */}
                <div className="px-5 py-3 flex items-center justify-between border-b border-gray-100 select-none">
