...
const MODE = 'execute'; // Directly execute the imports
...
const baseDir = 'd:/Desktop/aaa/blenderlar';
const stationaryFile = 'd:/Desktop/aaa/blenderlar/blenders_stationary.json';
const handFile = 'd:/Desktop/aaa/blenderlar/blenders_hand.json';
...
function translateToUzbek(val) {
    ...
    const replacements = [
        ...
        { rx: /Замешивание testa/g, rep: "Xamir qorishtirish" },
        { rx: /Замешивание testa/g, rep: "Xamir qorishtirish" },
...
async function run() {
    console.log(`=== STARTING BLENDER IMPORT TO DB ===\n`);
